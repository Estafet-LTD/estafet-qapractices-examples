...
public final class RestApiStepDefs {
    ...
    private static final String SITE_URL = "http://httpbin.org/";
    ...
    @Then("^the user check if user \"(.*)\" exist$")
    public void userCheckIfUserExist(String name) {
        ReqResUserModel userModel = new ReqResUserModel();
    ...
    public void userDeleteNewUserById() {
